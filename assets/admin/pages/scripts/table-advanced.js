...
*/
        ...
        var tableWrapper = $('#patientTable_wrapper'); // datatable creates the table wrapper by adding with id {your_table_jd}_wrapper

        tableWrapper.find('.dataTables_length select').select2(); // initialize select2 dropdown
    }

    var initTable8 = function () {
        var table = $('#studyTable');
...
*/
        ...
        var tableWrapper = $('#studyTable_wrapper'); // datatable creates the table wrapper by adding with id {your_table_jd}_wrapper
