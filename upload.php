   ...
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <div class="modal-body">
            ...
            <textarea rows="4" style="box-sizing: border-box; width:100%; -webkit-box-sizing: border-box; -moz-box-sizing: border-box; resize:none;" name="email" id="email" form="form-search">
			</textarea>
            </form>
