		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<tr>
					<td style="width:20%"><label for="editName">Patient's Name</label></td>
					<td style="width:40%"><input class="form-control" id="editName" type="text" name="editName" maxlength="30" required/></td>
					<td id="eNError" style="display:none;width:40%;"><p style="color:red">Enter Proper name</p></td>
					</tr>
					<tr>
					<td style="width:20%"><label for="editDOB">Date of Birth</label></td>
					<td><input class="form-control" id="editDOB" type="text" name="editDOB" required/></td>
					<td id="edobError" style="display:none;width:40%;"><p style="color:red">Enter Proper DOB</p></td>
					</tr>
					<tr>
					<td style="width:20%"><label for="editadd1">Address1</label></td>
					<td><input class="form-control" id="editadd1" type="text" name="editadd1" maxlength="30"/></td>
					<td id="eA1Error" style="display:none;width:40%;"><p style="color:red">Enter Proper Address</p></td>
					</tr>
					<tr>
					<td style="width:20%"><label for="editadd2">Address2</label></td>
					<td><input class="form-control" id="editadd2" type="text" name="editadd2" maxlength="50"/></td>
					<td id="eA2Error" style="display:none;width:40%;"><p style="color:red">Enter Proper Address</p></td>
					</tr>
					<tr>
					<td style="width:20%"><label for="editpincode">Pincode</label></td>
					<td><input class="form-control" id="editpincode" type="text" name="editpincode" maxlength="6" /></td>
					<td id="ePError" style="display:none;width:40%;"><p style="color:red">Enter Proper Pincode</p></td>
					</tr>
					</div>
					</tbody>
					</table>
					...
					data-dismiss="modal">Cancel
						...
						<button id = "newPatient" class="open-patientRegisterModal btn btn-primary" data-toggle="modal" data-target="#patientRegisterModal">New Patient..</button>
						...
						<td style="width:20%"><label for="patientName">Patient's Name</label></td>
						<td style="width:40%"><input class="form-control" id="patientName" type="text" name="patientName" maxlength="30" required/></td>
						<td id="pNError" style="display:none;width:20%;"><p style="color:red">Enter Proper name</p></td>
						</tr>
						<tr>
						<td style="width:20%"><label for="patientdob">Date of Birth</label></td>
						<td><div class="input-group input-medium date date-picker" data-date="12-02-2012" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
						...
						<td id="pdobError" style="display:none;"><p style="color:red">Enter Proper DOB</p></td>
						</tr>
						<tr>
						<td style="width:20%"><label for="patientGender">Gender</label></td>
						...
						<td id="pGError" style="display:none;"><p style="color:red">Enter Proper Gender</p></td>
						</tr>
						<tr>
						<td style="width:20%"><label for="patientAddress1">Address1</label></td>
						<td><input class="form-control" id="patientAddress1" type="text"  name="patientAddress1"/></td>
						<td id="pA1Error" style="display:none;width:40%;"><p style="color:red">Enter Proper Address</p></td>
						</tr>
						<tr>
						<td style="width:20%"><label for="patientAddress2">Address2</label></td>
						<td><input class="form-control" id="patientAddress2" type="text" name="patientAddress2"/></td>
						<td id="pA2Error" style="display:none; width:40%;"><p style="color:red">Enter Proper Address</p></td>
						</tr>
						<tr>
						<td style="width:20%"><label for="patientPincode">Pincode</label></td>
						<td><input class="form-control" id="patientPincode" type="text" name="patientPincode" maxlength="6" required/></td>
						<td id="pPError" style="display:none; width:40%;"><p style="color:red">Enter Proper pincode</p></td>
						</tr>
						</div>
...
<script type="text/javascript">
					...
					if(mess == null || mess == "") {
		document.getElementById("eNError").setAttribute("style","display:block");
		return;
	}
	else {
		document.getElementById("eNError").setAttribute("style","display:none");
	}
					var mess1 = document.getElementById("pkID").value;
					var mess2 = document.getElementById("editDOB").value;
					if(mess2 == null || mess2 == "") {
		document.getElementById("edobError").setAttribute("style","display:block");
		return;
	}
	else {
		document.getElementById("edobError").setAttribute("style","display:none");
	}
					var mess3 = document.getElementById("editadd1").value;
					if(mess3 == null || mess3 == "") {
		document.getElementById("eA1Error").setAttribute("style","display:block");
		return;
	}
	else {
		document.getElementById("eA1Error").setAttribute("style","display:none");
	}
		...
		document.getElementById("ePError").setAttribute("style","display:block");
		return;
	}
	else {
		document.getElementById("ePError").setAttribute("style","display:none");
	}
					var str = "cmnt";
					var str1 = "name";
					var str2 = "dob";
...
$(document).on('click','#patientRegister',function(e) {
	...
	if(patientName == null || patientName == "") {
		...
		document.getElementById("pNError").setAttribute("style","display:none");
	}
	var patientDOB1 = document.getElementById("patientdob").value;
	if(patientDOB1 == null || patientDOB1 == "") {
		document.getElementById("pdobError").setAttribute("style","display:block");
		return;
	}
	else {
		document.getElementById("pdobError").setAttribute("style","display:none");
	...
	document.getElementById("pGError").setAttribute("style","display:none");
	...
	document.getElementById("pGError").setAttribute("style","display:none");
		...
		document.getElementById("pGError").setAttribute("style","display:block");
		return;
	}
	var patientAddress1 = document.getElementById("patientAddress1").value;
	if(patientAddress1 == null || patientAddress1 == "") {
		document.getElementById("pA1Error").setAttribute("style","display:block");
		return;
	}
	else {
		document.getElementById("pA1Error").setAttribute("style","display:none");
	}
	...
	if(patientPincode == null || patientPincode == "" || isNaN(patientPincode) || patientPincode.length!=6) {
		document.getElementById("pPError").setAttribute("style","display:block");
		return;
	}
	else {
		document.getElementById("pPError").setAttribute("style","display:none");
	}
 ...
 <!-- <script>
  ...
  $(function() {
    ...
    $("#patientRegisterForm").validate({
        ...
        messages: {
            patientName: "Please enter your first name",
            patientdob: "Please enter your last name",
            /*password: {
