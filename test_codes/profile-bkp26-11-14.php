		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<td><input class="form-control" id="editName" type="text" name="editName" maxlength="30" required/></td>
					...
					data-dismiss="modal">Cancel
						...
						<td id="pNError" style="display:none;width:40%;"><p style="color:red">Enter Proper name</p></td>
						</tr>
						<tr>
						...
						<td style="width:40%"><input class="form-control" id="patientAddress1" type="text"  name="patientAddress1"/></td>
						...
						<td id="pA2Error" style="display:none;"><p style="color:red">Enter Proper Address</p></td>
						</tr>
						<tr>
						...
						<td id="pPError" style="display:none;"><p style="color:red">Enter Proper pincode</p></td>
						</tr>
						</div>
